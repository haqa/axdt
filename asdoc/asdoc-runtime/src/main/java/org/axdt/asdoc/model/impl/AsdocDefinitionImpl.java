...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Doc Named</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.axdt.asdoc.model.impl.AsdocDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class AsdocDefinitionImpl extends AsdocElementImpl implements AsdocDefinition {
	/**
	...
	protected EClass eStaticClass() {
		return AsdocEPackage.Literals.ASDOC_DEFINITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsdocEPackage.ASDOC_DEFINITION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsdocEPackage.ASDOC_DEFINITION__NAME:
				return getName();
		}
